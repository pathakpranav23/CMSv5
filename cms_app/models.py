...
class Student(db.Model):
    ...
    home_taluka = db.Column(db.String(96))
    home_district = db.Column(db.String(96))
    home_state = db.Column(db.String(96))
    home_pincode = db.Column(db.String(12))
    location_confidence = db.Column(db.Integer)
    location_source = db.Column(db.String(32))
    location_review_status = db.Column(db.String(24))
    location_suggestion_json = db.Column(db.Text)
    location_reviewed_by_user_id_fk = db.Column(db.Integer, db.ForeignKey("users.user_id"))
    location_reviewed_at = db.Column(db.DateTime)
